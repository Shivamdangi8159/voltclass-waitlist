    ...
    <div className="relative w-full max-w-[240px] aspect-[9/19.5] bg-black rounded-[34px] p-2.5 shadow-2xl ring-1 ring-white/10 shrink-0">
      ...
      <div className="w-full h-full rounded-[26px] overflow-hidden bg-gradient-to-br from-[#11161D] to-[#07090C]">
        {src ? (
          ...
          <div className="h-full m-2 flex flex-col items-center justify-center gap-2 text-center px-4 border border-dashed border-white/15 rounded-2xl">
            <Smartphone className="w-5 h-5 text-[#9AA4B2]" />
            <span className="text-xs font-bold text-[#9AA4B2]">{label}</span>
      ...
      <main>
        ...
        <section id="about" className="relative pt-40 pb-20 px-4 text-center overflow-hidden">
          ...
          <div className="relative max-w-3xl mx-auto">
            ...
            <h1 className="font-black tracking-tight leading-[1.05] text-4xl sm:text-6xl mb-6 text-white">
              Prepare smarter.
              <br />
              Practice harder.
              <br />
            ...
            <p className="text-[#9AA4B2] text-base leading-relaxed max-w-xl mx-auto mb-9">
            ...
            <div className="flex flex-wrap justify-center gap-3 mb-16">
              ...
              <Link
                href="/courses"
                className="inline-flex items-center gap-2 border border-white/15 text-white font-extrabold text-sm px-7 py-3.5 rounded-full hover:border-white/30 transition-colors"
              >
            ...
            {showcase.map((row, i) => (
              ...
              >
                <div className="text-center md:text-left">
                  <h3 className="text-2xl font-black text-white mb-3">{row.title}</h3>
                  <p className="text-sm text-[#9AA4B2] leading-relaxed max-w-md mx-auto md:mx-0">
                    {row.desc}
                  </p>
                </div>
        ...
        {/* ------------------------------------------------------ FEATURES */}
        <section id="features" className="bg-[#0D1117] border-y border-white/10 py-24 px-4">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
              {appFeatures.map((item) => (
                <div
                  key={item.title}
                  className="bg-[#11161D] border border-white/10 hover:border-[#00E5FF]/40 rounded-2xl p-6 transition-all hover:-translate-y-1"
                >
                  <div className="w-11 h-11 rounded-xl bg-[#00E5FF]/10 text-[#00E5FF] flex items-center justify-center mb-4">
                    {item.icon}
                  </div>
                  <h3 className="text-base font-bold text-white mb-2">{item.title}</h3>
                  <p className="text-sm text-[#9AA4B2] leading-relaxed">{item.desc}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section id="waitlist" className="py-24 px-4">
          <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <p className="text-sm text-[#9AA4B2] leading-relaxed max-w-md mb-6">
              ...
              <Link
                href="/courses"
                className="inline-flex items-center gap-2 text-sm font-bold text-white hover:text-[#00E5FF] transition-colors"
              >
                See batches &amp; fees <ArrowRight className="w-4 h-4" />
              </Link>
            </div>

            <div className="bg-[#11161D] border border-white/10 rounded-2xl p-7">
        ...
        <section className="max-w-2xl mx-auto px-4 py-24">
          ...
          <div className="text-center mt-8">
            <Link
              href="/faq"
              className="inline-flex items-center gap-2 text-sm font-bold text-[#00E5FF] hover:text-white transition-colors"
            >
