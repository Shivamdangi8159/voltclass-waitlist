  ...
  return (
    <div className="min-h-screen bg-[#07090C] text-white">
      ...
      <main className="pt-32 pb-20 max-w-4xl mx-auto px-4">
        ...
        <p className="text-center text-[#9AA4B2] mb-12">The 4-step system for continuous score improvement.</p>
        ...
        <div className="space-y-6">
          {[
            ...
            <div key={item.step} className="bg-[#11161D] border border-white/10 p-6 rounded-2xl flex gap-6 items-start">
